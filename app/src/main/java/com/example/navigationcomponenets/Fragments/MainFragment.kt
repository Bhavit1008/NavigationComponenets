package com.example.navigationcomponenets.Fragments
...
import com.example.navigationcomponenets.R
...
class MainFragment : Fragment(),View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        when(v!!.id){
            R.id.view_transactions_btn -> navController!!.navigate(R.id.action_mainFragment_to_viewTransectionFragment)
